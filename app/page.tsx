      ...
      particles.forEach((particle, i) => {
        particles.slice(i + 1).forEach((otherParticle) => {
          ...
          if (distance < 150) {
            ...
            ctx.strokeStyle = `rgba(${connectionColor}, ${0.1 * (1 - distance / 150)})`
            ctx.stroke()
          }
        })
      })
...
export default function Portfolio() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Real-time collaborative task management with Vue.js and Firebase",
      image: "/placeholder.svg?height=300&width=400",
    ...
    >
      ...
      >
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <motion.div whileHover={{ scale: 1.05 }} className="text-xl font-bold text-blue-500">
            AR.DEV
          </motion.div>

          {/* Desktop Menu */}
          <div className="hidden lg:flex space-x-8 items-center">
            {["Inicio", "Sobre mí", "Proyectos", "Experiencia", "Contacto"].map((item, index) => (
              <motion.a
                key={item}
                href={`#${["inicio", "about", "projects", "experience", "contact"][index]}`}
      ...
      <section id="inicio" className="min-h-screen flex items-center justify-center relative">
        <motion.div style={{ y }} className="text-center z-10 px-6">
          <motion.div
            ...
            className="mb-8"
          >
            <div className="text-sm text-blue-500 mb-4 font-mono">{"> Inicializando sistema..."}</div>
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              <span
                className={`text-transparent bg-clip-text bg-gradient-to-r ${
                  theme === "dark" ? "from-white to-blue-400" : "from-slate-900 to-blue-500"
                }`}
              >
                {typedName}
              </span>
            ...
            <h2 className="text-xl md:text-2xl text-emerald-500 mb-6 font-mono">{typedRole}</h2>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 3 }}
              className={`text-lg mb-8 max-w-2xl mx-auto ${theme === "dark" ? "text-slate-300" : "text-slate-600"}`}
            >
      ...
      <section id="about" className="py-20 relative z-10">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              >
                <CardContent className="p-8">
                  ...
                  <p className={`mb-6 ${theme === "dark" ? "text-slate-300" : "text-slate-600"}`}>
                    Con más de 4 años de experiencia creando soluciones digitales innovadoras. Me especializo en
                    tecnologías modernas y siempre busco la excelencia en cada proyecto.
                  </p>
            ...
            >
              <div>
                <h4 className="text-lg font-semibold text-blue-500 mb-2">Stack Favorito</h4>
                <div className="flex flex-wrap gap-2">
                  {["React", "Next.js", "Node.js", "TypeScript", "Python", "PostgreSQL", "MongoDB", "AWS"].map(
                    (tech) => (
                      <motion.span
                        key={tech}
                        whileHover={{ scale: 1.1 }}
              ...
              <div>
                <h4 className="text-lg font-semibold text-emerald-500 mb-2">Filosofía</h4>
                <p className={theme === "dark" ? "text-slate-300" : "text-slate-600"}>
                  "El código limpio no es solo funcional, es arte. Cada línea debe contar una historia, cada función
                  debe tener un propósito claro, y cada proyecto debe superar las expectativas."
                </p>
              </div>
            </motion.div>
          </div>
            ...
            {experiences.map((exp, index) => (
              ...
              >
                ...
                <div className={`w-1/2 ${index % 2 === 0 ? "pr-8 text-right" : "pl-8 ml-auto"}`}>
                  ...
                  >
                    <CardContent className="p-6">
                      <div className="text-blue-500 font-bold text-lg mb-2">{exp.year}</div>
                      ...
                      <p className={theme === "dark" ? "text-slate-300" : "text-slate-600"}>{exp.description}</p>
                    </CardContent>
                  </Card>
                </div>
              </motion.div>
            ))}
            <div className="absolute left-1/2 transform -translate-x-1/2 w-1 bg-gradient-to-b from-blue-500 to-emerald-500 h-full top-0"></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            >
              ...
              <p className={`mb-8 ${theme === "dark" ? "text-slate-300" : "text-slate-600"}`}>
                ¿Tienes un proyecto en mente? ¿Quieres colaborar? No dudes en contactarme. Siempre estoy abierto a
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span>alejandro@example.com</span>
                </motion.a>
                <motion.a
      ...
      {/* Footer */}
      <footer className={`py-8 border-t relative z-10 ${theme === "dark" ? "border-slate-700" : "border-slate-200"}`}>
        <div className="container mx-auto px-6 text-center">
          <p className={theme === "dark" ? "text-slate-400" : "text-slate-600"}>
            © 2024 Alejandro Enrique Rivera Vasquez. Todos los derechos reservados.
          </p>
